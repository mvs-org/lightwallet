...
@Injectable()
export class DnaUtilWsApiProvider {

    static _initedInstance:boolean = false
    static _initedSubscribe:boolean = false
    static _initedChainstore:boolean = false
    ...
    static async instance(wSub = false, wChain = false) {
    ...
    static async waitForInstance() {
        return this._waitFor("_initedInstance")
    }

    static async waitForSubscribe() {
        return this._waitFor("_initedSubscribe")
    }

    static async waitForChainstore() {
        return this._waitFor("_initedChainstore")
    }

    static async _waitFor(boolKey) {
        let that = this;
