...
let BASE_REG_URL = BASE_URL + '/wsloan';
// HTTP RPC
let HTTP_RPC_URL = 'https://explorer.mvsdnadev.com/rpcloan'; //'https://mvsdna.info/ws';
// WS RPC
let WS_RPC_URL = 'wss://explorer.mvsdnadev.com/wsloan';
